...
validateToken(token, verifyOptions)
  .then(() => {
...
By default this package verifies Azure tokens with the `RS256` algorithm. You can
still pass the usual `jsonwebtoken` verification options to add `audience`,
`issuer`, and similar claim checks.
